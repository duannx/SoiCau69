...
import { IonicPage, NavController, NavParams, MenuController, Platform, Loading, LoadingController, Alert, AlertController } from 'ionic-angular';
...
@Component({
  selector: 'page-xsmb',
  templateUrl: 'xsmb.html',
})
export class XsmbPage {
  datas = {
    mDate: new Date(),
    mDateStr: "",
    mTypeStr: "XSMB",
  ...
  constructor(
    ...
    if (this.mNavParams.get("date")) {
      this.datas.mDate = this.mNavParams.get("date");
    }
